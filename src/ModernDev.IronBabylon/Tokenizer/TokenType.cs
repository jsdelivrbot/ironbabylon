...
namespace ModernDev.IronBabylon
{
    public class TokenType
    {
        ...
        protected static Dictionary<string, TokenContext> TC => TokenContext.Types;
        ...
        public Action<Tokenizer, TokenType> UpdateContext { get; set; }
        ...
        public static TokenType BinopToken(string name, int prec) => new TokenType(name, new TokenTypeConfig
        {
            BeforeExpr = true,
            Binop = prec
        });

        public static TokenType Kw(string name, TokenTypeConfig options = null)
        {
